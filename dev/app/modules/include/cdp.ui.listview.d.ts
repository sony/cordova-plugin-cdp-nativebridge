...
declare module CDP {
    module UI {
        ...
        module ListViewGlobalConfig {
            ...
            var WRAPPER_SELECTOR: string;
            var SCROLL_MAP_CLASS: string;
            var SCROLL_MAP_SELECTOR: string;
            var INACTIVE_CLASS: string;
            var INACTIVE_CLASS_SELECTOR: string;
            var RECYCLE_CLASS: string;
            var RECYCLE_CLASS_SELECTOR: string;
            var LISTITEM_BASE_CLASS: string;
            var LISTITEM_BASE_CLASS_SELECTOR: string;
            var DATA_PAGE_INDEX: string;
            var DATA_CONTAINER_INDEX: string;
        }
    }
}
declare module CDP {
    module UI {
        ...
        module _ListViewUtils {
             ...
             * @return {Number} value
             */
            var getCssMatrixValue: (element: JQuery, type: string) => number;
            /**
             ...
             */
            var setTransformsTransitions: (element: JQuery, prop: string, msec: number, timingFunction: string) => void;
            /**
             * transition 設定の削除
             *
             * @private
             * @param {Object} element
             */
            var clearTransitions: (element: JQuery) => void;
            /**
             * Math.abs よりも高速な abs
             */
             ...
             * Math.max よりも高速な max
             */
            var max: (lhs: number, rhs: number) => number;
        }
    }
}
declare module CDP {
...
declare module CDP {
    module UI {
         ...
         */
        class ListItemView<TModel extends Backbone.Model> extends Backbone.View<TModel> implements IListItemView {
            private _owner;
...
declare module CDP {
    module UI {
         ...
         */
        class ListView<TModel extends Backbone.Model> extends Backbone.View<TModel> implements IListView {
            private _scrollMgr;
            /**
             * constructor
             *
